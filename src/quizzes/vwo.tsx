...
export const vwoConfig: QuizConfig = {
  ...
  accentColor: "#FF7A00",
  accentColorDim: "#DB6400",
  accentColorSubtle: "rgba(255,122,0,0.10)",
  bgColor: "#FAFBFD",
  bgElevated: "#FFFFFF",
  bgSurface: "#FFFFFF",
  ...
  borderSubtle: "#E9EEF4",
  scorecardBg: "#111827",
  scorecardAccentColor: "#FF9A3D",
  scorecardDivider: "#253248",
  scorecardLabelColor: "#A8B5C8",
  scorecardGridColor: "#253248",
  logo: (
    <img
      src="/logos/vwo.png"
      alt="VWO"
