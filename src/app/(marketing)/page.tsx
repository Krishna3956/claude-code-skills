...
const COMPARISON_ROWS = [
  ...
  { label: "Estimated cost", docs: "$2-5K/mo (writers + tools)", videos: "$3-8K/mo (production + hosting)", webinars: "$2-6K/mo (host time + platform)", lms: "$10K+/year + setup", hwyk: "Freemium" },
];
