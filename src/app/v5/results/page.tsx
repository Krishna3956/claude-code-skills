...
function ResultContent() {
    ...
    return (
      <div className="flex min-h-dvh items-center justify-center px-4">
        <div className="text-center">
          ...
          <Link href="/v5" style={{ color: "var(--v5-accent)" }} className="hover:underline text-sm">
            Take the test &rarr;
          </Link>
        </div>
      </div>
  ...
  const siteUrl = typeof window !== "undefined" ? `${window.location.origin}/v5` : "";
  ...
  return (
    <div className="flex min-h-dvh flex-col items-center px-4 py-8">
      ...
      >
        ...
        >
          <div className="px-6 pt-5 pb-3 text-center relative">
            ...
            <button
              ...
              style={{ background: "var(--v5-bg)", color: "var(--v5-text-secondary)", border: "1px solid var(--v5-border)" }}
            >
            ...
            <p style={{ color: "var(--v5-accent)", fontSize: "18px", letterSpacing: "0.02em", fontFamily: "var(--font-v5-serif), ui-serif, Georgia, serif" }} className="mb-5">
            ...
            >
              {result.overallScore}
              <span style={{ fontSize: "18px", color: "var(--v5-text-tertiary)", fontWeight: 400, marginLeft: "4px" }}>/100</span>
            </div>
            ...
            <p className="mt-2 mx-auto max-w-[280px]"
              style={{ color: "var(--v5-text-secondary)", fontSize: "12px", lineHeight: 1.6 }}>
          ...
          <div className="px-5 pb-5 flex flex-col gap-2">
            {result.dimensions.map((dim) => (
              <div key={dim.dimension} className="flex items-center justify-between py-1">
                <span style={{ color: "var(--v5-text-tertiary)", fontSize: "11px" }} className="w-24 truncate">
                  {dim.label}
                </span>
                <div className="flex items-center gap-2 flex-1 ml-3">
                  <div className="flex-1 h-1 rounded-full overflow-hidden"
                    style={{ background: "var(--v5-bg)" }}>
                    <div className="h-full rounded-full" style={{ width: `${dim.score}%`, background: "var(--v5-accent)" }} />
                  </div>
                  <span className="font-mono w-6 text-right" style={{ color: "var(--v5-accent)", fontSize: "11px", opacity: 0.7 }}>
                    {dim.score}
                  </span>
                </div>
              </div>
          ...
          <div className="px-5 py-3 flex items-center justify-center"
            style={{ borderTop: "1px solid var(--v5-border-subtle)" }}>
            <span style={{ color: "var(--v5-text-tertiary)", fontSize: "9px", opacity: 0.5 }}>
              howclaudecode.dev
            </span>
          </div>
        </div>
        ...
        <div className="w-full flex flex-col gap-3">
          <div className="flex gap-3">
            <a
              ...
              className="flex-1 flex items-center justify-center gap-2.5 py-3 rounded-xl text-sm transition-colors"
              style={{ border: "1px solid var(--v5-border)", color: "var(--v5-text)" }}
            >
        ...
        <Link href="/v5" className="text-xs transition-colors mt-1 flex items-center gap-1"
